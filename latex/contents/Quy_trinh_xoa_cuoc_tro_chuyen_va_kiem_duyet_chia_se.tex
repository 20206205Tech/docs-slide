\begin{frame}{Quy trình xóa cuộc trò chuyện và chia sẻ}
\begin{figure}[H]
\centering
\includegraphics[height=0.7\textheight,width=0.9\textwidth,keepaspectratio]{pictures/delete-chat-validation-share.png}
