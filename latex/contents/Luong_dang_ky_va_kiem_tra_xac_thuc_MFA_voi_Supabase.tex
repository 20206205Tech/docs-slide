\begin{frame}{Luồng xác thực MFA với Supabase}
\begin{figure}[H]
\centering
\includegraphics[height=0.7\textheight,width=0.9\textwidth,keepaspectratio]{pictures/auth-mfa-flow.excalidraw.png}
