\begin{frame}{Phân chia miền phụ (Subdomain)}
\begin{figure}[H]
\centering
...
Chúng ta có Miền phụ cốt lõi (Core Subdomain) tập trung vào nghiệp vụ chính là tư vấn pháp lý và đàm thoại, Miền phụ hỗ trợ (Supporting Subdomain) như quản lý tài liệu, trò chuyện, thanh toán và Miền phụ chung (Generic Subdomain) như xác thực tài khoản.
}
\end{frame}
