...
Mã khóa bí mật được máy chủ tạo ra và hiển thị dưới dạng mã QR. Người dùng dùng ứng dụng Authenticator để quét và lưu trữ. Mỗi 30 giây, ứng dụng và máy chủ sẽ tự động tính toán ra một mã số gồm 6 chữ số dựa trên . Khi đăng nhập, người dùng nhập mã này để đối chiếu.
}
\end{frame}
