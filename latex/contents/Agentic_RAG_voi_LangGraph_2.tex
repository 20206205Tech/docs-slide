...
hệ thống thực hiện truy xuất và lấy song song 4 nguồn dữ liệu tài liệu cá nhân, tóm tắt tài liệu, văn bản pháp luật, pháp điển
\hrule

tiếp theo hệ thống, xếp hạng hạng tài liệu, thử viết lại câu hỏi (nếu cần)
\hrule

nếu nguồn tri thức không đủ hệ thống lấy thông tin ở 2 trang web thư viện pháp luật và luật việt nam
\hrule
